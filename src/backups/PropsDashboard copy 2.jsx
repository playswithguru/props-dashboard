...
export default function PropsDashboard() {
  ...
  const getLineColor = tag => getBorderColorByTag(tag);
    ...
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif", minHeight: "100vh", ...themeStyles }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <img src="/logo/playswithguru-logo.png" alt="PlaysWithGuru Logo" style={{ height: "104px", marginRight: "1rem" }} />
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
        ...
        <button onClick={() => setShowLineupSection(prev => !prev)} style={{ padding: "0.5rem 1rem" }}>
          {showLineupSection ? "Hide Lineup Generator" : "Generate Lineups"}
        </button>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "1.5rem" }}>
        {filteredProps.map((p, idx) => (
          <div key={idx} style={{
            borderLeft: `4px solid ${getBorderColorByTag(p.Tag)}`,
            borderRadius: "16px",
            padding: "1rem",
